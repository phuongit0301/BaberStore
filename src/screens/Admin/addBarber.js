        ...
        try {
            ...
            let userData = {
              ...
              database().ref(`Users/${response.user.uid}`).update(userData).then(()=>{
                Alert.alert(
                    'Barber Created',
                    'Barber can now login with his account and reset password!',
                    [
                        { text: 'Back Home', onPress: () => this.props.navigation.navigate('Admin',{name:'Admin'}) },
                    ]
                  );
                ...
                <View style={styles.wrapper}>
                    ...
                    <View style={styles.inputSection}>
                        <View style={styles.form}>
                            <TextInput onChangeText={(e)=>this.setState({name: e})} style={styles.textInput} placeholderTextColor={Colors.TEXT_GREY} placeholder="Barber Name" />  

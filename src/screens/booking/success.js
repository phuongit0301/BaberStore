            ...
            <View style={styles.wrapper}>
                ...
                <View style={styles.inputSection}>
                    <View style={styles.form}>
                        ...
                        <Text style={styles.successText}>Your Appointment is Successfull</Text>
                    </View>
                    <View style={styles.buttons}>
                        <TouchableOpacity onPress={()=>this.props.navigation.navigate('Home',{name:'Home'})} style={styles.signUpButton}>
